...
class NcclDestroy(object):
    def __del__(self):
        if torch is not None:
            torch._C._nccl_destroy()

# this ensures that when the process ends, ncclCommDestroy is called on the C side.
destroy_object = NcclDestroy()
